...
int main(void) {
	...
	/*This register contains status flags indicating the state of the I2C module during operation.*/
	I2C1STAT = 0x0;
	
	/*This register holds the slave device adress, QUESTION: Do we need one?*/
	// I2C1ADD
